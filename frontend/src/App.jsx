...
function App() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_BASE_URL}/auth/refresh`, { withCredentials: true })
      .then(() => {
        // ✅ If refresh succeeds, also get user info:
        return axios.get(`${import.meta.env.VITE_API_BASE_URL}/members/user`, { withCredentials: true });
      })
      .then((res) => {
