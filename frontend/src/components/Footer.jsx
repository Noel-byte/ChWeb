      ...
      <div className="relative w-full bg-[#1F2937] text-white pt-6 pb-4">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {/* Services */}
            <div>
              <h2 className="font-titles text-sm md:text-base mb-1">
                Services
              </h2>
            ...
            <div>
              ...
              <ul className="space-y-0.5">
                <li className="font-titles text-xs">Phone : 780-850-4000</li>
            ...
            <div>
              ...
              <ul className="space-y-0.5">
                <li className="font-titles text-xs">6425 120 Ave NW </li>
          ...
          <div className="mt-4 pt-3 border-t border-gray-700">
            <p className="text-center text-gray-400 text-xs">
              © {new Date().getFullYear()} Assumption of Mary Geez Rite Eritrean
              Catholic Church of Edmonton. All rights reserved.
            </p>
          </div>
        </div>
      </div>
