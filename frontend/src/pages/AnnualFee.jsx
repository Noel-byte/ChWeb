      ...
      <fieldset className="border border-green-600 rounded-xl p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
          <div className="flex flex-col">
            <label className="text-sm font-medium text-gray-600 mb-1">{t('firstname')}</label>
          ...
          <div className="flex flex-col">
            <label className="text-sm font-medium text-gray-600 mb-1">{t('lastname')}</label>
            <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
          ...
          <div className="flex flex-col md:col-span-2">
            <label className="text-sm font-medium text-gray-600 mb-1">{t('email')}</label>
            <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
              {userInfo?.email || 'N/A'}
            </div>
          </div>
          ...
          <div className="flex flex-col md:col-span-2">
            <label className="text-sm font-medium text-gray-600 mb-1">{t('membershiptype')}</label>
            <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
